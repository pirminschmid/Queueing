#!/bin/sh
# controls additional experiment 820 full system writes with more workers
# 3 memtier VM, 2 middleware, 3 memcached server
...
for iteration in 1 2 3 4; do
    for cv in 1 2 4 8 12 16 24 32 48 64; do
