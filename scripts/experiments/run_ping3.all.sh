...
# parameters: r run; ping_size; name1; ip1; name2; ip2; name3; ip3
...
#ping -n $ip3 >$data_path/r_${r}_app_ping_id_${type}${id}${name3}-default.ping.data &
...
#ping -s $ping_size -n $ip3 >$data_path/r_${r}_app_ping_id_${type}${id}${name3}-long.ping.data
...
echo "pings from ${type}${id} to ${name1}, ${name2}, ${name3} stopped"
